...
public class ShipController : Status
{
    ...
    void Start()
    {
        playerselection = GameObject.FindGameObjectWithTag("Data").GetComponent<PlayerSelection>();
        SetStatus();
        SetPlayerSelection();
        SetShootRate();
        SetDamage();
    ...
    {
        myDroneType = playerselection.GetDroneType();
        mySecondaryCannonType = playerselection.GetCannonType();
        currentSpecialAble = playerselection.GetSpecialType();
